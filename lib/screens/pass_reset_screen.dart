        ...
        children: <Widget>[
          ...
          Container(
            ...
            child: Text(
              ...
              style:
                const TextStyle(color: Color.fromRGBO(6, 88, 246, 1), fontSize: 30, fontWeight: FontWeight.bold)
            ),
          ),
          ...
          DefaultScreenButton(appRoute: AppRoutes.confirmPassReset, text: "Redefinir senha"),
          const SizedBox(height: 30),
          TextScreenButton(
